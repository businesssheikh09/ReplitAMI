...
- [Express sub-router middleware leaks path scope](express-router-scoped-middleware.md) — bare router.use(mw) in a domain router mounted with no prefix affects ALL routes, not just its own; always scope with a path
