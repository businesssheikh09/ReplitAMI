    ...
    <footer className="relative bg-primary text-primary-foreground pt-16 pb-8 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="font-serif text-2xl font-semibold tracking-wide mb-4">Noor Al-Haram</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              ...
              <li>info@nooralharam.pk</li>
              <li>+92 300 1234567</li>
              <li>UAN: 111-NOOR-PK</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-primary-foreground/20 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-primary-foreground/60">
            &copy; {new Date().getFullYear()} Noor Al-Haram Travels. All rights reserved.
          </p>
