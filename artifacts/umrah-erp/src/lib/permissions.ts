...
export const ROUTE_PERMISSIONS: Record<string, UserRole[]> = {
  ...
  "/hotel-invoices": ALL,
  "/general-journal": FINANCE_FULL,
  "/accounting/vouchers": FINANCE_FULL,
  "/accounting/ledger": FINANCE_FULL,
  "/accounting/trial-balance": FINANCE_FULL,
  "/accounting/reports": FINANCE_FULL,
  "/accounting/pnl": FINANCE_FULL,
  "/accounting/balance-sheet": FINANCE_FULL,
  "/accounting/financial-years": ADMIN_MGMT,
